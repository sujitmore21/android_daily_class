...
import static com.example.notification.NotificationHelper.GROUP_KEY;
import static com.example.notification.NotificationHelper.NEGATIVE_CLICK;
import static com.example.notification.NotificationHelper.POSITIVE_CLICK;
import static com.example.notification.NotificationHelper.REPLY_CLICK;
import static com.example.notification.NotificationHelper.REPLY_TEXT_KEY;
...
public class NotificationSampleActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void showStandardNotification() {
        ...
        NotificationCompat.Builder notification = NotificationHelper.createNotificationBuider(this,
                "Notification", "Standard notification!", R.drawable.ic_notifications_black_24dp, pIntent);
    ...
    public void showHeadsUpNotification() {
        ...
        NotificationCompat.Builder notification = NotificationHelper.createNotificationBuider(this,
                "Notification", "Heads-Up Notification!", R.drawable.ic_notifications_black_24dp, pIntent);

        notification.setPriority(Notification.PRIORITY_HIGH).setVibrate(new long[0]);

        notification.addAction(new NotificationCompat.Action(R.drawable.ic_notifications_black_24dp, "Postive", pIntent_positive));
        notification.addAction(new NotificationCompat.Action(R.drawable.ic_notifications_black_24dp, "Negative", pIntent_negative));
    ...
    public void showRemoteInputNotification() {
        ...
        NotificationCompat.Builder notification = NotificationHelper.createNotificationBuider(this,
                "Remote Input", "Notification with Remote Input", R.drawable.ic_notifications_black_24dp);
        ...
        NotificationCompat.Action action =
                new NotificationCompat.Action.Builder(R.drawable.ic_send_black_24dp, "Reply", pIntent_positive)
    ...
    public void showSummaryNotification() {
        ...
        NotificationCompat.Builder summary_notification = NotificationHelper.createNotificationBuider(this,
                "2 new messages", "Bundle notification!", R.drawable.ic_notifications_black_24dp, pIntent);
        ...
        NotificationCompat.Builder notification1 = NotificationHelper.createNotificationBuider(this,
                "Ashwin", "Check this out", R.drawable.ic_notifications_black_24dp, pIntent);
        ...
        NotificationCompat.Builder notification2 = NotificationHelper.createNotificationBuider(this,
                "Ranjith", "Launch Party", R.drawable.ic_notifications_black_24dp, pIntent);
